    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-center text-lg-left">
          <p class="social">
            <a aria-label="LinkedIn" href="https://www.linkedin.com/in/jdpaiva1/">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" class="fab svg-inline--fa fa-linkedin-in fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path fill="currentColor" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
              </svg>
            </a>
            <a aria-label="GitHub" href="https://github.com/JDPaiva1">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" class="fab svg-inline--fa fa-github fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            <a aria-label="Twitter" href="https://twitter.com/JDPaiva1">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" class="fab svg-inline--fa fa-twitter fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <a aria-label="Instagram" href="https://www.instagram.com/jdpaiva1/">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" class="fab svg-inline--fa fa-instagram fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <a aria-label="500px" href="https://500px.com/jdpaiva1">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="500px" class="fab svg-inline--fa fa-500px fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div class="col-md-6 text-center text-lg-right mt-4 mt-lg-0 text-faded">
          <h5 style="text-align: end">© 2019 JDPaiva1.</h5>
        </div>
      </div>
    </div>
  </footer>
